...
class CDMSerModel(nn.Module):
    def __init__(self, config: CDMConfig) -> None:
        super().__init__()
        self.config = config
...
def build_cdm_ser_model(model_cfg: dict, embedding_dim: int) -> CDMSerModel:
    config = CDMConfig(
