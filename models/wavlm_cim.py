...
class CIMMemoryModule(nn.Module):
...
class WavLMCIMSerModel(nn.Module):
...
def build_wavlm_cim_ser_model(model_cfg: dict, embedding_dim: int) -> WavLMCIMSerModel:
    config = WavLMCIMConfig(
